...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-gradient-light">
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                className="bg-brand-gradient transform hover:scale-105 transition-all duration-200 text-brand-white"
              >
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <Card key={index} className="group hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border-0 bg-brand-white/80 backdrop-blur-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="text-xl font-bold mb-2 text-brand-gray-800">{service.title}</h4>
                    <p className="text-brand-gray-600 mb-4">{service.description}</p>
      ...
      {/* Features Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-brand-rose-100/50 to-brand-purple-100/50">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-brand-gray-600">Abierto de lunes a sábado con horarios convenientes para ti</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-brand-gray-600">Productos de alta gama y técnicas profesionales certificadas</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-brand-gray-600">Cada cliente es único, por eso adaptamos nuestros servicios a ti</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {hairStyles.map((style) => (
              <Card key={style.id} className="group hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border-0 bg-brand-white/80 backdrop-blur-sm overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-brand-gray-600 mb-4">{style.description}</p>
                  <Button 
                    className="w-full transform hover:scale-105 transition-all duration-200 bg-brand-gradient text-brand-white"
                  >
                    Ver Más Detalles
                  </Button>
                </CardContent>
      ...
      {/* Contact Section */}
      <section id="contacto" className="py-16 px-4 text-brand-white bg-brand-gradient">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-brand-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <form className="space-y-4">
                ...
                ></textarea>
                <Button 
                  className="w-full bg-brand-white text-brand-primary hover:bg-brand-gray-100 transform hover:scale-105 transition-all duration-200"
                >
                  Enviar Mensaje
                </Button>
              </form>
